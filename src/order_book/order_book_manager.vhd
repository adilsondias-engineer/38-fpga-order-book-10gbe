...
--    end component;
    ...
    attribute MAX_FANOUT of price_cmd_valid: signal is 16;
    attribute MAX_FANOUT of price_cmd_type: signal is 16;
    attribute MAX_FANOUT of price_cmd_addr: signal is 16;
    attribute MAX_FANOUT of price_cmd_price: signal is 16;
    attribute MAX_FANOUT of price_cmd_shares: signal is 16;
    attribute MAX_FANOUT of price_cmd_side: signal is 16;
    attribute MAX_FANOUT of price_rd_level: signal is 16;
    attribute MAX_FANOUT of price_rd_valid: signal is 16;
    attribute MAX_FANOUT of price_bid_count: signal is 16;
    attribute MAX_FANOUT of price_ask_count: signal is 16;
    attribute MAX_FANOUT of msg_order_ref: signal is 16;
    attribute MAX_FANOUT of msg_price: signal is 16;
    attribute MAX_FANOUT of msg_shares: signal is 16;
    attribute MAX_FANOUT of msg_type_reg: signal is 16;
    attribute MAX_FANOUT of msg_side: signal is 16;
...
begin
    ...
    order_storage_inst : entity work.order_storage
        port map (
            clk         => clk,
            rst         => rst,
            wr_en       => stor_wr_en,
    ...
    price_level_table_inst : entity work.price_level_table
        port map (
            clk             => clk,
            rst             => rst,
    ...
    bbo_tracker_inst : entity work.bbo_tracker
        port map (
            clk             => clk,
            rst             => rst,
            ...
            if rst = '1' then
                ...
                case state is
                    ...
                    when ADD_ORDER =>
                        ...
                        wait_counter <= 3;  -- 3 cycles: pipe_cmd + pipe_d1 + pipe_d2/write
